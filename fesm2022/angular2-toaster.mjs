...
import { Optional, Injectable, Pipe, EventEmitter, ViewContainerRef, Component, Input, ViewChild, Output, HostListener, NgModule } from '@angular/core';
...
class ToasterContainerComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.2", ngImport: i0, type: ToasterContainerComponent, deps: [{ token: ToasterService }], target: i0.ɵɵFactoryTarget.Component });
